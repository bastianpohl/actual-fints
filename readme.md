...
```bash
# Fetch transactions for the default range (the last SYNC_LOOKBACK_DAYS days)
npm start
...
```bash
# Transaktionen für den Standard-Zeitraum abrufen (die letzten SYNC_LOOKBACK_DAYS Tage)
npm start
